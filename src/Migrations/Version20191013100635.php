 ...
 */
final class Version20191013100635 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE expanse CHANGE member_id member_id INT DEFAULT NULL, CHANGE type_id type_id INT DEFAULT NULL');
